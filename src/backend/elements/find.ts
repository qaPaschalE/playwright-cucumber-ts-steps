...
Step("I pw find element by selector {string}", findElementBySelector, "When");
Step("I pw get element by selector {string}", findElementBySelector, "When");
Step("I pw find element by text {string}", findElementByText, "When");
Step("I pw find element by title {string}", findElementByTitle, "When");
Step("I pw find element by testid {string}", findElementByTestId, "When");
Step("I pw find element by role {string}", findElementByRole, "When");
Step("I pw find element by placeholder text {string}", findElementByPlaceholder, "When");
Step("I pw find element by label text {string}", findElementByLabel, "When");
Step("I pw find element by alt text {string}", findElementByAltText, "When");
Step("I pw find link by text {string}", findLinkByText, "When");
Step("I pw find heading by text {string}", findHeadingByText, "When");
Step("I pw find element by name {string}", findElementByName, "When");
Step("I pw find elements by selector {string}", findElementsBySelector, "When");
Step("I pw get elements by selector {string}", findElementsBySelector, "When");
...
Step("I pw find input by display value {string}", findInputByValue, "When");
Step("I pw find input by placeholder text {string}", findInputByPlaceholder, "When");
Step("I pw find headings by text {string}", findHeadingsByText, "When");
Step("I pw find input by ID {string}", findInputById, "When");
Step("I pw find input by name {string}", findInputByName, "When");